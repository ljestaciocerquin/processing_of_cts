...
if __name__ == '__main__':
    ...
    # Data
    parser.add_argument('--output_dir',  type=str, default='/projects/disentanglement_methods/processing_of_cts/output/',     help='folder to save all outputs from train | test | survival |visualization')
    parser.add_argument('--data_path' ,  type=str, default='/projects/disentanglement_methods/processing_of_cts/data/data_script6.xlsx', help='path that contains the data. It could be a folder(tcia) or a csv file (nki)') # /processing/l.estacio/data_tcia/train/
    ...
    parser.add_argument('--filters',     type=int, default=[8, 16, 32, 64],              help='filters to create the Affine and Deformation networks') #[16, 32, 64, 128]
    ...
    parser.add_argument('--filters_disc',type=int, default=[16, 32, 64],               help='filters to create the Discriminator network')
